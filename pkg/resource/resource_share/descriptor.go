...
const (
	FinalizerString = "finalizers.ram.services.k8s.aws/ResourceShare"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resourceshares")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResourceShare{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ResourceShare),
	}
}
