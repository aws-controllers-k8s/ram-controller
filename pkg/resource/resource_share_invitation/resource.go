...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.ResourceShareInvitationARN = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["resourceShareInvitationARN"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: resourceShareInvitationARN"))
	}
	r.ko.Spec.ResourceShareInvitationARN = &primaryKey
