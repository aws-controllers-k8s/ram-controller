...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Status.ResourceShareARN = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["resourceShareARN"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: resourceShareARN"))
	}
	r.ko.Status.ResourceShareARN = &primaryKey
