...
const (
	FinalizerString = "finalizers.ram.services.k8s.aws/ResourceShareAccepter"
)

var (
	// GroupKind is the metav1.GroupKind for the ResourceShareAccepter resource
...
// resourceDescriptor implements the acktypes.AWSResourceDescriptor interface
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResourceShareAccepter{}
}
