...
const (
	finalizerString = "finalizers.ram.services.k8s.aws/Permission"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("permissions")
