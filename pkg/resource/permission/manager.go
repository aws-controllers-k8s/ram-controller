...
// +kubebuilder:rbac:groups=ram.services.k8s.aws,resources=permissions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ram.services.k8s.aws,resources=permissions/status,verbs=get;update;patch
